...
public class TransformerMessageDeserializer extends TransformerBase {
	...
	static{
		...
		DESERIALIZER_PATTERN =	new AbstractInsnNode[] 
				...
				new VarInsnNode   (Opcodes.ALOAD, -1),
				new MethodInsnNode(Opcodes.INVOKEVIRTUAL, ObfTable.PACKET_READPACKETDATA.getClazz(), ObfTable.PACKET_READPACKETDATA.getName(), ObfTable.PACKET_READPACKETDATA.getDescriptor()),
				};
