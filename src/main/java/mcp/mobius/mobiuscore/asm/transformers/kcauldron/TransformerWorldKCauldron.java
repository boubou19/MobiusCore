...
public class TransformerWorldKCauldron extends TransformerBase{
    ...
    static{
        ...
        WORLD_PATTERN_LOADEDENTS = new  AbstractInsnNode[]
            {
                Opcode.ALOAD(0),
                Opcode.NEW("kcauldron/wrapper/ProcessingQueue"),
                Opcode.DUP(),
                Opcode.NEW("java/util/concurrent/ConcurrentLinkedQueue"),
                Opcode.DUP(),
                Opcode.INVOKESPECIAL("java/util/concurrent/ConcurrentLinkedQueue", "<init>", "()V"),
                Opcode.INVOKESPECIAL("kcauldron/wrapper/ProcessingQueue", "<init>", "(Ljava/util/Queue;)V"),
                Opcode.PUTFIELD(ObfTable.WORLD_LOADEDENTS_KC.getClazz(), ObfTable.WORLD_LOADEDENTS_KC.getName(), ObfTable.WORLD_LOADEDENTS_KC.getDescriptor())
            };
        ...
        WORLD_PATTERN_LOADEDTILES = new  AbstractInsnNode[]
            {
                ...
                Opcode.INVOKESPECIAL("java/util/concurrent/ConcurrentLinkedQueue", "<init>", "()V"),
                Opcode.INVOKESPECIAL("kcauldron/wrapper/ProcessingQueue", "<init>", "(Ljava/util/Queue;)V"),
                Opcode.PUTFIELD(ObfTable.WORLD_LOADEDTILES_KC.getClazz(), ObfTable.WORLD_LOADEDTILES_KC.getName(), ObfTable.WORLD_LOADEDTILES_KC.getDescriptor())
            };
        
        WORLD_PAYLOAD_LOADEDENTS = new  AbstractInsnNode[]
            {
                Opcode.ALOAD(0),
                Opcode.NEW("mcp/mobius/mobiuscore/monitors/MonitoredEntityQueue"),
                Opcode.DUP(),
                Opcode.ALOAD(0),
                Opcode.GETFIELD(ObfTable.WORLD_LOADEDENTS_KC.getClazz(), ObfTable.WORLD_LOADEDENTS_KC.getName(), ObfTable.WORLD_LOADEDENTS_KC.getDescriptor()),
                Opcode.CHECKCAST("kcauldron/wrapper/ProcessingQueue"),
                Opcode.INVOKEVIRTUAL("kcauldron/wrapper/ProcessingQueue", "unwrap", "()Ljava/util/Collection;"),
                Opcode.CHECKCAST("java/util/Queue"),
                Opcode.INVOKESPECIAL("mcp/mobius/mobiuscore/monitors/MonitoredEntityQueue", "<init>", "(Ljava/util/Queue;)V"),
                Opcode.PUTFIELD(ObfTable.WORLD_LOADEDENTS_KC.getClazz(), ObfTable.WORLD_LOADEDENTS_KC.getName(), ObfTable.WORLD_LOADEDENTS_KC.getDescriptor())
            };
        ...
        WORLD_PAYLOAD_LOADEDTILES = new  AbstractInsnNode[]
            {
                Opcode.ALOAD(0),
                Opcode.NEW("mcp/mobius/mobiuscore/monitors/MonitoredTileQueue"),
                Opcode.DUP(),
                Opcode.ALOAD(0),
                Opcode.GETFIELD(ObfTable.WORLD_LOADEDTILES_KC.getClazz(), ObfTable.WORLD_LOADEDTILES_KC.getName(), ObfTable.WORLD_LOADEDTILES_KC.getDescriptor()),
                Opcode.CHECKCAST("kcauldron/wrapper/ProcessingQueue"),
                Opcode.INVOKEVIRTUAL("kcauldron/wrapper/ProcessingQueue", "unwrap", "()Ljava/util/Collection;"),
                Opcode.CHECKCAST("java/util/Queue"),
                Opcode.INVOKESPECIAL("mcp/mobius/mobiuscore/monitors/MonitoredTileQueue", "<init>", "(Ljava/util/Queue;)V"),
                Opcode.PUTFIELD(ObfTable.WORLD_LOADEDTILES_KC.getClazz(), ObfTable.WORLD_LOADEDTILES_KC.getName(), ObfTable.WORLD_LOADEDTILES_KC.getDescriptor())
            };        
    }
